...
include("../prof/verifica.php");

    //Gambiarra para mostrar o nome do anluno
    $name = "SELECT nome_professor FROM professor WHERE email_professor = '{$_SESSION['usuarioprof']}'";
...
<head>
    ...
    <title>UDF CHALLENGE - PROFESSOR LOBBY</title>
    ...
    <link rel="icon" href="./img/icon-dp.png" type="image/vnd.microsoft.icon">
...
<div class="wrapper">
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li><a href="#pageSubmenu" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">Escala</a>
            ...
            <li>
                <a class="active" href="../prof/logout.php">Sair</a>
            </li>
